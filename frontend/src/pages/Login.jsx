      ...
      <div className="w-full max-w-5xl grid md:grid-cols-2 bg-surface-container-lowest rounded-[40px] overflow-hidden shadow-[0_20px_40px_rgba(44,44,44,0.06)]">
          ...
          <div className="absolute bottom-12 left-12 right-12 z-10">
            <div className="bg-surface/80 backdrop-blur-xl p-8 rounded-[32px]">
              ...
              <h2 className="font-headline text-3xl font-bold tracking-tighter text-tertiary leading-tight mb-4">
                Seamless access to your next curated experience.
              </h2>
              <p className="text-on-surface-variant font-body text-sm leading-relaxed">
                Join our community of organizers and enthusiasts. Every detail handled with precision, every booking a memory.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-8 md:p-16 flex flex-col justify-center">
          <div className="mb-10 text-center md:text-left">
            <h3 className="font-headline text-4xl font-extrabold tracking-tighter text-tertiary mb-2">Welcome Back</h3>
            <p className="text-on-surface-variant font-body">Please select your role to continue your journey.</p>
          </div>
          ...
          <div className="mt-12 text-center">
            <p className="text-sm text-on-surface-variant font-body">
              ...
              <Link to="/signup" className="text-primary font-bold hover:underline ml-1">Start your membership</Link>
            </p>
          </div>
        </div>
      </div>
